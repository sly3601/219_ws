    ...
    const hardware_interface::HardwareInfo& info)
{
    ...
    */
     // 修改限幅2026.02.06
        ...
        joint_type_limits_["hip"] = {-0.638, 0.748, -30.1, 30.1, -4.0, 4.0};
        joint_type_limits_["thigh"] = {-0.623, 1.65, -30.1, 30.1, -4.0, 4.0};
        joint_type_limits_["calf"] = {-2.322, -0.672, -20.06, 20.06, -4.0, 4.0};
