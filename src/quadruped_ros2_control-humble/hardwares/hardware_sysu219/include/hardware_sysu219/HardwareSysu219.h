...
#ifndef HARDWARESYSU219_H
#define HARDWARESYSU219_H
...
#include <vector>
#include <memory>
#include "hardware_sysu219/imu.hpp" 
...
class HardwareSysu219 final : public hardware_interface::SystemInterface {
public:
